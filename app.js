function getResults() {
	...
	$.ajax({
		...
		for (var i = 0; i < Math.min(articles.response.docs.length, numberOfRecords); i++) {
			var newArticle = $("<div class='indivresult'>");
			...
			newArticle.append("<p class='articleauthor'>" + articles.response.docs[i].byline.original + "</p>");
